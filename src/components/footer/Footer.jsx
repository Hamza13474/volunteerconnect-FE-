...
const Footer = () => {
  return (
    <Container as="footer" role="contentinfo" bgColor={'#319442'} px={{ base: '5', md: '10', lg: '14', xl: '20' }} maxW={'full'} color={'white'}>
      {/* <Stack
        spacing="8"
        ...
        >
          ...
          <Stack spacing="4">
            ...
            <Stack spacing="4" direction={{ base: 'column', sm: 'row' }} maxW={{ lg: '360px' }}>
              <Input className='footer___input' placeholder="Enter your email" type="email" color={'white'} required />
