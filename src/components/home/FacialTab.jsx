...
import facialAvatar from '../../assets/images/facialAvatar.svg';
        ...
        <HStack alignItems={'flex-start'} p={'0'} spacing={'0'}>
            <VStack h={{ base: '42.5vh', md: 'auto' }} position={{ base: 'absolute', md: 'unset' }} bottom={'0'} bgColor={'#222127'} flex={'1'} alignItems={'flex-start'}>
                <VStack w={'609px'} borderColor={'#2D2C34'} borderWidth={'2px'} alignItems={'flex-start'} borderRadius={'10px'} p={'7'}>
                    <Text textTransform={'uppercase'}>Facial Style</Text>
                ...
                <VStack maxH={'400px'} overflowY={'auto'} borderColor={'#2D2C34'} borderWidth={'2px'} alignItems={'flex-start'} borderRadius={'10px'} p={'7'}>
                    <Text textTransform={'uppercase'}>FAcial color</Text>
            ...
            {/* <VStack flex={'1'} justifyContent={'center'} alignItems={'center'}>
                <Image src={facialAvatar} w={'509px'} h={'518px'} objectFit={'contain'} />
            </VStack> */}
        </HStack>
    )
}

export default FacialTab